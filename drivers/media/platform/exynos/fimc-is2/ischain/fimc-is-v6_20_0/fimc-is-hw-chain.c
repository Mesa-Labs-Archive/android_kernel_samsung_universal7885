...
int fimc_is_hw_ischain_cfg(void *ischain_data)
{
	...
	/* set CSISX4 - 3AA0 path MUX
	 * 0 : CSIS0 - 3AA0 => Rear
	 * 1 : CSIS1 - 3AA1 => Front
	 * 2 : CSIS2 - 3AA0 => Front dual
	 * 3 : CSIS3
	...
	case 0:
		is_val = fimc_is_hw_set_field_value(is_val,
				&sysreg_is_fields[SYSREG_IS_F_CSISX4_MUX_3AA1_VAL], csi->instance);
		break;
	case 1:
		is_val = fimc_is_hw_set_field_value(is_val,
				&sysreg_is_fields[SYSREG_IS_F_CSISX4_MUX_3AA0_VAL], csi->instance);
		break;
	case 2:
		is_val = fimc_is_hw_set_field_value(is_val,
				&sysreg_is_fields[SYSREG_IS_F_CSISX4_MUX_3AA0_VAL], csi->instance);
