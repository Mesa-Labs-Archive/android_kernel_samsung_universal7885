...
#define IST40XX_NVM_TSP_TEST_DATA       0
#define IST40XX_NVM_OFFSET_CAL_COUNT    1
#define IST40XX_NVM_OFFSET_TUNE_VERSION	2
...
/*TCLM CONCEPT */
#define IST40XX_NVM_OFFSET_CAL_POSITON			3
#define IST40XX_NVM_OFFSET_HISTORY_QUEUE_COUNT		4
#define IST40XX_NVM_OFFSET_HISTORY_QUEUE_LASTP		5
#define IST40XX_NVM_OFFSET_HISTORY_QUEUE_ZERO		6
#define IST40XX_NVM_OFFSET_HISTORY_QUEUE_SIZE		6	/* QUEUE SIZE 6 */
