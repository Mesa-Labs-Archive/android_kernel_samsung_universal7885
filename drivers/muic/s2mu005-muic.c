...
static int com_to_jig_usb(struct s2mu005_muic_data *muic_data)
{
	enum s2mu005_reg_manual_sw_value val;
	int ret = 0;
...
static int attach_jig_usb(struct s2mu005_muic_data *muic_data)
{
	pr_info("%s\n", __func__);
	return com_to_jig_usb(muic_data);
}
