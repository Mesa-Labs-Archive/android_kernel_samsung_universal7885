...
#define SEMCONTEXT_AP_STATUS_SHUTDOWN                   0xD0
#define SEMCONTEXT_AP_STATUS_WAKEUP                     0xD1
#define SEMCONTEXT_AP_STATUS_SLEEP                      0xD2
#define SEMCONTEXT_AP_STATUS_RESUME                     0xD3
#define SEMCONTEXT_AP_STATUS_SUSPEND                    0xD4
#define SEMCONTEXT_AP_STATUS_RESET                      0xD5
#define SEMCONTEXT_AP_STATUS_POW_CONNECTED              0xD6
#define SEMCONTEXT_AP_STATUS_POW_DISCONNECTED           0xD7
#define SEMCONTEXT_AP_STATUS_CALL_IDLE                  0xD8
#define SEMCONTEXT_AP_STATUS_CALL_ACTIVE                0xD9

#define SEMCONTEXT_INST_LIBRARY_ADD                     0xB1
#define SEMCONTEXT_INST_LIBRARY_REMOVE                  0xB2
#define SEMCONTEXT_INST_LIB_NOTI                        0xB4
#define SEMCONTEXT_INST_LIB_SET_DATA                    0xC1
#define SEMCONTEXT_INST_LIB_GET_DATA                    0xB8
...
#define SEMCONTEXT_VALUE_LIBRARY_DATA                   0x17

#define SEMCONTEXT_VALUE_CURRENTSTATUS                  0x01
#define SEMCONTEXT_VALUE_CURRENTSTATUS_BATCH            0x02
#define SEMCONTEXT_VALUE_VERSIONINFO                    0x03
