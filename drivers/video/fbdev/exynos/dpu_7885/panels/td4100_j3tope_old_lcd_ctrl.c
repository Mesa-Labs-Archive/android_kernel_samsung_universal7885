...
#include "td4100_j3tope_old_param.h"
...
struct dsim_lcd_driver td4100_mipi_old_lcd_driver = {
	.name		= "td4100_old",
...
/********** For old panel runtime change **********/
static int td4100_old_module_init(void)
{
	register_lcd_driver(&td4100_mipi_old_lcd_driver);
	return 0;
}
module_init(td4100_old_module_init);
