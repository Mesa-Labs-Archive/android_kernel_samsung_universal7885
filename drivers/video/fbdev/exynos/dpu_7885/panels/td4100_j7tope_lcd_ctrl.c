/* linux/drivers/video/fbdev/exynos/decon_7885/panels/td4100_j3neo_lcd_ctrl.c
 *
...
static int td4100_module_init(void)
{
	register_lcd_driver(&td4100_mipi_lcd_driver);
	return 0;
}
module_init(td4100_module_init);
